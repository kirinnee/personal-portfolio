...
const hobbyMap = [
    ...
    new HobbyData("TeleCharts", images.sideProject.tele,
        "<p>TeleCharts is an online application to analyze conversation within a time frame from Telegram. </p>" +
        "<p>TeleChart provides a beautiful dashboard to show the conversation between two people, including the breakdown of different media within the conversation such as stickers, photo, videos, audios. Statistics such as messages, words, emojis per day, per month are also provided in both text and graph formats. </p>"
        + "<p> TeleChart currently works on 16:9 to screens, and not on mobile phones due to the non-responsive design. This may or may not be worked on in the future.</p>"
        + "<p> TeleChart is mainly built with Vue.js in TypeScript using Chart.js, and is fully open-sourced at GitLab.</p>",
        "https://telegram.kirinnee.dev",
        [
            images.icons.frontend.vue,
            images.icons.frontend.sass,
            images.black.ts,
