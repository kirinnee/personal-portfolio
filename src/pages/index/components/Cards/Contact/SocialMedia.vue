<template>
    <a class="media" :href="Link" rel="noreferrer" target="_blank" @mouseenter="hover=true" @mouseleave="hover=false">
        <Pic :src="NonHover" class="nonhover f" :style="nhStyle" uncenter type="b"/>
        <Pic :src="Hover" class="hover f" :style="hStyle" uncenter type="b"/>
    </a>
</template>
